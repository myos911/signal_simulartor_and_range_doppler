...
class RadarGeometryGPU():

    def __init__(self, radarGeometryCPU: RadarGeometry):
        self.trajectory_angle = radarGeometryCPU.trajectory_angle
        self.side_looking_angle = radarGeometryCPU.side_looking_angle    
        self.forward_squint_angle = radarGeometryCPU.forward_squint_angle
        self.x_s = cp.asarray(radarGeometryCPU.x_s)
        self.y_s = cp.asarray(radarGeometryCPU.y_s)
        self.z_s = cp.asarray(radarGeometryCPU.z_s)
        self.Bs2c = cp.asarray(radarGeometryCPU.Bs2c)
        self.Bc2s = cp.asarray(radarGeometryCPU.Bc2s)

        # self.abs_v = cp.array(radarGeometryCPU.abs_v)
        self.abs_v = radarGeometryCPU.abs_v

        self.velocity = cp.asarray(radarGeometryCPU.velocity)
        self.S_0 = cp.asarray(radarGeometryCPU.S_0)

        # DEBUGGING
        # print(type(self.trajectory_angle))
        # print(type(self.side_looking_angle))
        # print(type(self.forward_squint_angle))
        # print(type(self.x_s))
        # print(type(self.y_s))
        # print(type(self.z_s))
        # print(type(self.Bs2c))
        # print(type(self.Bc2s))
        # print(type(self.abs_v))
